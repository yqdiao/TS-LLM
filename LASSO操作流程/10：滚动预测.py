...
for i in range(n_stocks):
    ...
    start_index = 1  # 因为080000为NaN，从080100时刻开始
    ...
    for j in range(start_index + window_size, len(returns_col_scaled)):
        ...
        lasso_cv.fit(X_train.T, y_train)  # 使用X_train.T使其形状为 (n_samples, n_features)
...
# 将预测结果保存为CSV文件
output_file_path = "C:\\Users\\A\\Desktop\\160105\\新output\\predicted_stock_returns.csv"
...
# 将最优alpha值保存为CSV文件
lambda_output_file_path = "C:\\Users\\A\\Desktop\\160105\\新output\\best_lambdas.csv"
